      ...
      <div className="container mx-auto px-4 flex flex-col md:flex-row gap-6 min-h-[400px] md:min-h-[450px]">
        ...
        <div className="flex-1 flex flex-col justify-center md:pl-12 lg:pl-20">
          ...
          <button
            ...
            className="bg-orange-500 hover:bg-orange-600 text-white px-6 py-4 rounded-lg shadow-md text-xl font-bold mt-10 inline-block w-max">
            Find Scholarship Now
          </button>
        </div>

        <div className="flex-1 flex justify-end relative">
          <img src="/assets/images/banner.png" alt="Scholarship Banner"
